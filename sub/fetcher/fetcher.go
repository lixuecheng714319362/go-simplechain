...
const (
	...
	arriveTimeout = time.Minute // Time allowance before an announced block is explicitly requested
	//gatherSlack   = 100 * time.Millisecond // Interval used to collate almost-expired announces with fetches
	gatherSlack  = time.Minute // Interval used to collate almost-expired announces with fetches
