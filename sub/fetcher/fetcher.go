...
const (
	...
	arriveTimeout = time.Second // Time allowance before an announced block is explicitly requested
	//gatherSlack   = 100 * time.Millisecond // Interval used to collate almost-expired announces with fetches
	gatherSlack = 500 * time.Millisecond // Interval used to collate almost-expired announces with fetches
	//fetchTimeout = 5 * time.Second        // Maximum allotted time to return an explicitly requested block
	fetchTimeout = time.Minute // Maximum allotted time to return an explicitly requested block
...
// peerAddressFn
type peerAddressFn func(id string) common.Address
